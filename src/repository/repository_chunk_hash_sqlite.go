...
func (rchs RepositoryChunkHashSqlite) RemoveByIds(ids []int64, tx *sql.Tx) error {
	query := `DELETE FROM chunk_hashes WHERE id = ?`
...
func (rchs RepositoryChunkHashSqlite) RemoveById(id int64, tx *sql.Tx) error {
